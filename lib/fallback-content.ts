...
const industriesByLocale: Record<AppLocale, FallbackIndustry[]> = {
  en: [
    { id: "fi-1", key: "mining", name: "Mining", summary: "Responsible extraction, processing, and supply continuity for strategic minerals.", imageUrl: "https://picsum.photos/seed/mining-enterprise/1200/800" },
    { id: "fi-2", key: "oil-gas", name: "Oil & Gas", summary: "Integrated upstream-downstream support focused on operational safety and uptime.", imageUrl: "https://picsum.photos/seed/oil-gas-enterprise/1200/800" },
    { id: "fi-3", key: "healthcare", name: "Hospital/Healthcare", summary: "Healthcare operations, clinical services, and hospital modernization initiatives.", imageUrl: "https://picsum.photos/seed/healthcare-enterprise/1200/800" },
    { id: "fi-4", key: "electrical", name: "Electrical", summary: "Industrial electrical systems, reliability engineering, and high-voltage execution.", imageUrl: "https://picsum.photos/seed/electrical-grid-enterprise/1200/800" },
    { id: "fi-5", key: "semiconductor", name: "Semiconductor", summary: "Supply chain and process support for precision semiconductor operations.", imageUrl: "https://picsum.photos/seed/semiconductor-enterprise/1200/800" },
    { id: "fi-6", key: "machinery", name: "Machinery", summary: "Heavy machinery systems integration, maintenance, and performance optimization.", imageUrl: "https://picsum.photos/seed/machinery-enterprise/1200/800" },
    { id: "fi-7", key: "ai", name: "AI", summary: "Applied AI for predictive operations, asset intelligence, and decision automation.", imageUrl: "https://picsum.photos/seed/ai-enterprise/1200/800" },
    { id: "fi-8", key: "manufacturing", name: "Manufacturing", summary: "Lean production and industrial transformation across multisector facilities.", imageUrl: "https://picsum.photos/seed/manufacturing-enterprise/1200/800" },
    { id: "fi-9", key: "civil-infrastructure", name: "Civil & Infrastructure", summary: "Engineering, delivery, and lifecycle support for national-scale infrastructure.", imageUrl: "https://picsum.photos/seed/civil-infrastructure-enterprise/1200/800" },
  ],
  id: [
    { id: "fi-1", key: "mining", name: "Pertambangan", summary: "Ekstraksi dan pemrosesan mineral strategis dengan prinsip tanggung jawab.", imageUrl: "https://picsum.photos/seed/mining-enterprise/1200/800" },
    { id: "fi-2", key: "oil-gas", name: "Minyak & Gas", summary: "Dukungan operasi hulu-hilir terintegrasi dengan fokus keselamatan.", imageUrl: "https://picsum.photos/seed/oil-gas-enterprise/1200/800" },
    { id: "fi-3", key: "healthcare", name: "Rumah Sakit/Kesehatan", summary: "Operasional layanan kesehatan, klinis, dan modernisasi rumah sakit.", imageUrl: "https://picsum.photos/seed/healthcare-enterprise/1200/800" },
    { id: "fi-4", key: "electrical", name: "Kelistrikan", summary: "Sistem kelistrikan industri, keandalan, dan eksekusi tegangan tinggi.", imageUrl: "https://picsum.photos/seed/electrical-grid-enterprise/1200/800" },
    { id: "fi-5", key: "semiconductor", name: "Semikonduktor", summary: "Dukungan proses dan rantai pasok untuk operasi semikonduktor presisi.", imageUrl: "https://picsum.photos/seed/semiconductor-enterprise/1200/800" },
    { id: "fi-6", key: "machinery", name: "Permesinan", summary: "Integrasi sistem alat berat, perawatan, dan optimasi performa.", imageUrl: "https://picsum.photos/seed/machinery-enterprise/1200/800" },
    { id: "fi-7", key: "ai", name: "AI", summary: "Penerapan AI untuk prediksi operasional dan otomasi keputusan.", imageUrl: "https://picsum.photos/seed/ai-enterprise/1200/800" },
    { id: "fi-8", key: "manufacturing", name: "Manufaktur", summary: "Transformasi produksi dan peningkatan efisiensi fasilitas industri.", imageUrl: "https://picsum.photos/seed/manufacturing-enterprise/1200/800" },
    { id: "fi-9", key: "civil-infrastructure", name: "Sipil & Infrastruktur", summary: "Rekayasa, konstruksi, dan dukungan siklus hidup infrastruktur skala nasional.", imageUrl: "https://picsum.photos/seed/civil-infrastructure-enterprise/1200/800" },
  ],
};
