...
const industriesByLocale: Record<AppLocale, FallbackIndustry[]> = {
  en: [
    { id: "fi-1", key: "mining", name: "Mining", summary: "Responsible extraction, processing, and supply continuity for strategic minerals.", imageUrl: "https://source.unsplash.com/1600x900/?mining,excavator,open-pit" },
    { id: "fi-2", key: "oil-gas", name: "Oil & Gas", summary: "Integrated upstream-downstream support focused on operational safety and uptime.", imageUrl: "https://source.unsplash.com/1600x900/?oil,gas,refinery" },
    { id: "fi-3", key: "healthcare", name: "Hospital/Healthcare", summary: "Healthcare operations, clinical services, and hospital modernization initiatives.", imageUrl: "https://source.unsplash.com/1600x900/?hospital,healthcare,medical" },
    { id: "fi-4", key: "electrical", name: "Electrical", summary: "Industrial electrical systems, reliability engineering, and high-voltage execution.", imageUrl: "https://source.unsplash.com/1600x900/?electrical,power-grid,substation" },
    { id: "fi-5", key: "semiconductor", name: "Semiconductor", summary: "Supply chain and process support for precision semiconductor operations.", imageUrl: "https://source.unsplash.com/1600x900/?semiconductor,microchip,circuit-board" },
    { id: "fi-6", key: "machinery", name: "Machinery", summary: "Heavy machinery systems integration, maintenance, and performance optimization.", imageUrl: "https://source.unsplash.com/1600x900/?industrial,machinery,factory-equipment" },
    { id: "fi-7", key: "ai", name: "AI", summary: "Applied AI for predictive operations, asset intelligence, and decision automation.", imageUrl: "https://source.unsplash.com/1600x900/?artificial-intelligence,data-center,technology" },
    { id: "fi-8", key: "manufacturing", name: "Manufacturing", summary: "Lean production and industrial transformation across multisector facilities.", imageUrl: "https://source.unsplash.com/1600x900/?manufacturing,industrial-robotics,assembly-line" },
    { id: "fi-9", key: "civil-infrastructure", name: "Civil & Infrastructure", summary: "Engineering, delivery, and lifecycle support for national-scale infrastructure.", imageUrl: "https://source.unsplash.com/1600x900/?infrastructure,construction,bridge" },
  ],
  id: [
    { id: "fi-1", key: "mining", name: "Pertambangan", summary: "Ekstraksi dan pemrosesan mineral strategis dengan prinsip tanggung jawab.", imageUrl: "https://source.unsplash.com/1600x900/?mining,excavator,open-pit" },
    { id: "fi-2", key: "oil-gas", name: "Minyak & Gas", summary: "Dukungan operasi hulu-hilir terintegrasi dengan fokus keselamatan.", imageUrl: "https://source.unsplash.com/1600x900/?oil,gas,refinery" },
    { id: "fi-3", key: "healthcare", name: "Rumah Sakit/Kesehatan", summary: "Operasional layanan kesehatan, klinis, dan modernisasi rumah sakit.", imageUrl: "https://source.unsplash.com/1600x900/?hospital,healthcare,medical" },
    { id: "fi-4", key: "electrical", name: "Kelistrikan", summary: "Sistem kelistrikan industri, keandalan, dan eksekusi tegangan tinggi.", imageUrl: "https://source.unsplash.com/1600x900/?electrical,power-grid,substation" },
    { id: "fi-5", key: "semiconductor", name: "Semikonduktor", summary: "Dukungan proses dan rantai pasok untuk operasi semikonduktor presisi.", imageUrl: "https://source.unsplash.com/1600x900/?semiconductor,microchip,circuit-board" },
    { id: "fi-6", key: "machinery", name: "Permesinan", summary: "Integrasi sistem alat berat, perawatan, dan optimasi performa.", imageUrl: "https://source.unsplash.com/1600x900/?industrial,machinery,factory-equipment" },
    { id: "fi-7", key: "ai", name: "AI", summary: "Penerapan AI untuk prediksi operasional dan otomasi keputusan.", imageUrl: "https://source.unsplash.com/1600x900/?artificial-intelligence,data-center,technology" },
    { id: "fi-8", key: "manufacturing", name: "Manufaktur", summary: "Transformasi produksi dan peningkatan efisiensi fasilitas industri.", imageUrl: "https://source.unsplash.com/1600x900/?manufacturing,industrial-robotics,assembly-line" },
    { id: "fi-9", key: "civil-infrastructure", name: "Sipil & Infrastruktur", summary: "Rekayasa, konstruksi, dan dukungan siklus hidup infrastruktur skala nasional.", imageUrl: "https://source.unsplash.com/1600x900/?infrastructure,construction,bridge" },
  ],
};
